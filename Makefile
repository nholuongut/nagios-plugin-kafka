...
# Alpine:
#
#   apk add --no-cache git make && git clone https://github.com/nholuongut/nagios-plugin-kafka && cd nagios-plugin-kafka && make

# Debian / Ubuntu:
#
#   apt-get update && apt-get install -y make git && git clone https://github.com/nholuongut/nagios-plugin-kafka && cd nagios-plugin-kafka && make

# RHEL / CentOS:
#
#   yum install -y make git && git clone https://github.com/nholuongut/nagios-plugin-kafka && cd nagios-plugin-kafka && make
