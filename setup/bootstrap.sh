...
# Alpine / Wget:
#
#   wget -O- https://raw.githubusercontent.com/nholuongut/Nagios-Plugin-Kafka/master/setup/bootstrap.sh | sh
#
# Curl:
#
#   curl https://raw.githubusercontent.com/nholuongut/Nagios-Plugin-Kafka/master/setup/bootstrap.sh | sh

set -eu
[ -n "${DEBUG:-}" ] && set -x
srcdir="$(dirname "$0")"

repo="https://github.com/nholuongut/nagios-plugin-kafka"

directory="nagios-plugin-kafka"
